...
namespace VNet.ProceduralGeneration.Cosmological.Configuration
{
    public class BaryonicMatterNodeGenerationSettings : ISettings
    {
        ...
        {
            this.CountTolerancePercentage = ConfigConstants.BaryonicMatterNode.CountTolerancePercentage;
            ...
            this.TopologyZVariancePercent = ConfigConstants.BaryonicMatterNode.TopologyZVariancePercent;
        }
    }
}