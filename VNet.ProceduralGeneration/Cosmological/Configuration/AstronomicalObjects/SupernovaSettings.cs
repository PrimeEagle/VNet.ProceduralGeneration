...
public class SupernovaSettings
{
    [Range(0, 5)]
    ...
    public SupernovaSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.Supernova.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.Supernova.ParallelismLevel;
    }
}