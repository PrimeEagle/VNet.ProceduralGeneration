...
public class QuarkStarSettings
{
    [Range(0, 5)]
    ...
    public QuarkStarSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.QuarkStar.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.QuarkStar.ParallelismLevel;
    }
}