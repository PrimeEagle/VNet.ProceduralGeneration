...
public class StarSystemSettings
{
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.StarSystem.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.StarSystem.ParallelismLevel;
    }
}