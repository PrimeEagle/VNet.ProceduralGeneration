...
public class BaryonicMatterFilamentStructureSettings
{
    [Range(0, 5)]
    ...
    public BaryonicMatterFilamentStructureSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.BaryonicMatterFilamentStructure.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.BaryonicMatterFilamentStructure.ParallelismLevel;
    }
}