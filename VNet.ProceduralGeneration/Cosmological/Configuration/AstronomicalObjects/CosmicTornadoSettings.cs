...
public class CosmicTornadoSettings
{
    [Range(0, 5)]
    ...
    public CosmicTornadoSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.CosmicTornado.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.CosmicTornado.ParallelismLevel;
    }
}