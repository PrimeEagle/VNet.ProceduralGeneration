...
public class MonopoleSettings
{
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.Monopole.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.Monopole.ParallelismLevel;
    }
}