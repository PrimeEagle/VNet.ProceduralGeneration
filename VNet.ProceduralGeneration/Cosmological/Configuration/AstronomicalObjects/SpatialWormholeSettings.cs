...
public class SpatialWormholeSettings
{
    [Range(0, 5)]
    ...
    public SpatialWormholeSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.SpatialWormhole.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.SpatialWormhole.ParallelismLevel;
    }
}