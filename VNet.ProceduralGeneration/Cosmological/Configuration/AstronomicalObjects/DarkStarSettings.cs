...
public class DarkStarSettings
{
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.DarkStar.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.DarkStar.ParallelismLevel;
    }
}