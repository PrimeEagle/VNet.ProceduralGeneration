...
public class VoidGalaxySettings
{
    [Range(0, 5)]
    ...
    public VoidGalaxySettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.VoidGalaxy.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.VoidGalaxy.ParallelismLevel;
    }
}