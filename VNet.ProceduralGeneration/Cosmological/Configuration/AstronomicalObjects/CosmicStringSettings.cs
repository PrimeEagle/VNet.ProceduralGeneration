...
public class CosmicStringSettings
{
    [Range(0, 5)]
    ...
    public CosmicStringSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.CosmicString.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.CosmicString.ParallelismLevel;
    }
}