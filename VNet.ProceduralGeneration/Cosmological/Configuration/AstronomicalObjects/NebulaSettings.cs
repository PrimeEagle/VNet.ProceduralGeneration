...
public class NebulaSettings
{
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.Nebula.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.Nebula.ParallelismLevel;
    }
}