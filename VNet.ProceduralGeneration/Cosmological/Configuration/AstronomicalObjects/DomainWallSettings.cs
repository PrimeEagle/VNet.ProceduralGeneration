...
public class DomainWallSettings
{
    [Range(0, 5)]
    ...
    public DomainWallSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.DomainWall.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.DomainWall.ParallelismLevel;
    }
}