...
public class KugelblitzSettings
{
    [Range(0, 5)]
    ...
    public KugelblitzSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.Kugelblitz.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.Kugelblitz.ParallelismLevel;
    }
}