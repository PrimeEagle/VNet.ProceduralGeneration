...
public class WhiteHoleSettings
{
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.WhiteHole.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.WhiteHole.ParallelismLevel;
    }
}