...
public class PlanetesimalSettings
{
    [Range(0, 5)]
    ...
    public PlanetesimalSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.Planetesimal.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.Planetesimal.ParallelismLevel;
    }
}