...
public class DebrisDiskSettings
{
    [Range(0, 5)]
    ...
    public DebrisDiskSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.DebrisDisk.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.DebrisDisk.ParallelismLevel;
    }
}