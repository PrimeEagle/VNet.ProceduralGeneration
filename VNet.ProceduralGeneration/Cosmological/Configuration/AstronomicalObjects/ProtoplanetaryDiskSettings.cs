...
public class ProtoplanetaryDiskSettings
{
    [Range(0, 5)]
    ...
    public ProtoplanetaryDiskSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.ProtoplanetaryDisk.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.ProtoplanetaryDisk.ParallelismLevel;
    }
}