...
public class SpatialWormholeSettings : ISettings
{
    [Required]
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.Theoretical.SpatialWormhole.RandomGenerationAlgorithm;
    }
}
