...
public class CuspCatastropheSettings : ISettings
{
    [Required]
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.Theoretical.CuspCatastrophe.RandomGenerationAlgorithm;
    }
}
