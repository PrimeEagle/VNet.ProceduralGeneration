...
public class DarkMatterNodeStructureSettings : ISettings
{
    [Required]
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.Theoretical.DarkMatterNodeStructure.RandomGenerationAlgorithm;
    }
}
