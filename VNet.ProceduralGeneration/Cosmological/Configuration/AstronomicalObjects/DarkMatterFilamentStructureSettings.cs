...
public class DarkMatterFilamentStructureSettings
{
    [Range(0, 5)]
    ...
    public DarkMatterFilamentStructureSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.DarkMatterFilamentStructure.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.DarkMatterFilamentStructure.ParallelismLevel;
    }
}