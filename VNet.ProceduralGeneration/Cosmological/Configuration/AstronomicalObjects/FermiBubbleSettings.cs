...
public class FermiBubbleSettings
{
    [Range(0, 5)]
    ...
    public FermiBubbleSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.FermiBubble.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.FermiBubble.ParallelismLevel;
    }
}