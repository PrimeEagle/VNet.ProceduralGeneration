...
public class BaryonicMatterSheetStructureSettings
{
    [Range(0, 5)]
    ...
    public BaryonicMatterSheetStructureSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.BaryonicMatterSheetStructure.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.BaryonicMatterSheetStructure.ParallelismLevel;
    }
}