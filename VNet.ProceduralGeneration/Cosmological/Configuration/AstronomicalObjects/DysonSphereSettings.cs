...
public class DysonSphereSettings
{
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.DysonSphere.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.DysonSphere.ParallelismLevel;
    }
}