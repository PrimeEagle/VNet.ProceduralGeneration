...
public class GalaxySettings
{
    ...
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.Galaxy.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.Galaxy.ParallelismLevel;
    }
}