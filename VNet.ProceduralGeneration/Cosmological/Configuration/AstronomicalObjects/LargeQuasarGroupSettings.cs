...
public class LargeQuasarGroupSettings
{
    [Range(0, 5)]
    ...
    public LargeQuasarGroupSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.LargeQuasarGroup.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.LargeQuasarGroup.ParallelismLevel;
    }
}