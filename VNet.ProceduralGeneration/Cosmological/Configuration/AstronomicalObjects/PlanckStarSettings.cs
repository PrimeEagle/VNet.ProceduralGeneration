...
public class PlanckStarSettings
{
    [Range(0, 5)]
    ...
    public PlanckStarSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.PlanckStar.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.PlanckStar.ParallelismLevel;
    }
}