...
public class StarCloudSettings
{
    [Range(0, 5)]
    ...
    public StarCloudSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.StarCloud.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.StarCloud.ParallelismLevel;
    }
}