...
public class SupernovaRemnantSettings
{
    [Range(0, 5)]
    ...
    public SupernovaRemnantSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.SupernovaRemnant.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.SupernovaRemnant.ParallelismLevel;
    }
}