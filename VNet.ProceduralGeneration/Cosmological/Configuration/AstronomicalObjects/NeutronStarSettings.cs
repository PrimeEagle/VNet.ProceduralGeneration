...
public class NeutronStarSettings
{
    [Range(0, 5)]
    ...
    public NeutronStarSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.NeutronStar.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.NeutronStar.ParallelismLevel;
    }
}