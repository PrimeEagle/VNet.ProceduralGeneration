...
public class GalaxyClusterSettings
{
    [Range(0, 5)]
    ...
    public GalaxyClusterSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.GalaxyCluster.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.GalaxyCluster.ParallelismLevel;
    }
}