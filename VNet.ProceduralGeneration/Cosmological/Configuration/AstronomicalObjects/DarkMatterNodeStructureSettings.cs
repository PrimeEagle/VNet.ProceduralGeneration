...
public class DarkMatterNodeStructureSettings
{
    [Range(0, 5)]
    ...
    public DarkMatterNodeStructureSettings()
    {
        RandomGenerationAlgorithm = Constants.Advanced.Objects.DarkMatterNodeStructure.RandomGenerationAlgorithm;
        ParallelismLevel = Constants.Advanced.Objects.DarkMatterNodeStructure.ParallelismLevel;
    }
}