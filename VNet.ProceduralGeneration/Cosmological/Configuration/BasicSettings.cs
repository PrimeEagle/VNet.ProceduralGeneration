...
public class BasicSettings : ISettings
{
    ...
    public float TopologyBaryonicMatterNodeMergeDistanceThreshold => Constants.BaryonicMatterNode.TopologyMergeDistanceThresholdFactor * AverageDimension;
    ...
    public float TopologyBaryonicMatterNodeMinDistanceThreshold => TopologyBaryonicMatterNodeMergeDistanceThreshold * Constants.BaryonicMatterNode.TopologyMinDistanceThresholdFactor;
    ...
    public float TopologyDarkMatterNodeMergeDistanceThreshold => Constants.DarkMatterNode.TopologyMergeDistanceThresholdFactor * AverageDimension;
    ...
    public float TopologyDarkMatterNodeMinDistanceThreshold => TopologyDarkMatterNodeMergeDistanceThreshold * Constants.DarkMatterNode.TopologyMinDistanceThresholdFactor;
    ...
    public BasicSettings()
    {
        ...
        DimensionX = Constants.Basic.DimensionX;
        DimensionY = Constants.Basic.DimensionY;
        DimensionZ = Constants.Basic.DimensionZ;
        MinDarkEnergyPercent = Constants.Basic.MinDarkEnergyPercent;
        MaxDarkEnergyPercent = Constants.Basic.MaxDarkEnergyPercent;
        MinDarkMatterPercent = Constants.Basic.MinDarkMatterPercent;
        MaxDarkMatterPercent = Constants.Basic.MaxDarkMatterPercent;
        MinBaryonicMatterPercent = Constants.Basic.MinBaryonicMatterPercent;
        MaxBaryonicMatterPercent = Constants.Basic.MaxBaryonicMatterPercent;
        MinUniverseAge = Constants.Basic.MinUniverseAge;
        MaxUniverseAge = Constants.Basic.MaxUniverseAge;
