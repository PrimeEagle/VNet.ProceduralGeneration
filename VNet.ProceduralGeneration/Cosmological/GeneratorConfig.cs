...
namespace VNet.ProceduralGeneration.Cosmological
{
    public class GeneratorConfig
    {
        ...
        private const double DARK_MATTER_FILAMENT_AGE_FACTOR = 10.0;
        private const double DARK_MATTER_FILAMENT_MASS_FACTOR = 1 / 1e30;
        private const double DARK_MATTER_FILAMENT_SIZE_FACTOR = 1 / 1e9;
        private const double DARK_MATTER_FILAMENT_BARYONIC_MATTER_PERCENT_FACTOR = 100;
        private const double DARK_MATTER_FILAMENT_DARK_MATTER_PERCENT_FACTOR = 150;
        private const double DARK_MATTER_FILAMENT_DARK_ENERGY_PERCENT_FACTOR = 100;
        private const double BARYONIC_MATTER_NODE_AGE_FACTOR = 10.0;
        ...
        private const double BARYONIC_MATTER_NODE_DARK_MATTER_PERCENT_FACTOR = 150;
        private const double BARYONIC_MATTER_NODE_DARK_ENERGY_PERCENT_FACTOR = 100;
        private const double DARK_MATTER_NODE_AGE_FACTOR = 10.0;
        private const double DARK_MATTER_NODE_MASS_FACTOR = 1 / 1e30;
        private const double DARK_MATTER_NODE_SIZE_FACTOR = 1 / 1e9;
        private const double DARK_MATTER_NODE_BARYONIC_MATTER_PERCENT_FACTOR = 100;
        private const double DARK_MATTER_NODE_DARK_MATTER_PERCENT_FACTOR = 150;
        private const double DARK_MATTER_NODE_DARK_ENERGY_PERCENT_FACTOR = 100;
        private const double BARYONIC_MATTER_SHEET_AGE_FACTOR = 10.0;
        ...
        private const double DARK_MATTER_SHEET_AGE_FACTOR = 10.0;
        private const double DARK_MATTER_SHEET_MASS_FACTOR = 1 / 1e30;
        private const double DARK_MATTER_SHEET_SIZE_FACTOR = 1 / 1e9;
        private const double DARK_MATTER_SHEET_BARYONIC_MATTER_PERCENT_FACTOR = 100;
        private const double DARK_MATTER_SHEET_DARK_MATTER_PERCENT_FACTOR = 150;
        private const double DARK_MATTER_SHEET_DARK_ENERGY_PERCENT_FACTOR = 100;
        private const double BARYONIC_MATTER_VOID_AGE_FACTOR = 10.0;
        ...
        private const double BARYONIC_MATTER_VOID_DARK_MATTER_PERCENT_FACTOR = 150;
        private const double BARYONIC_MATTER_VOID_DARK_ENERGY_PERCENT_FACTOR = 100;
        private const double DARK_MATTER_VOID_AGE_FACTOR = 10.0;
        private const double DARK_MATTER_VOID_MASS_FACTOR = 1 / 1e30;
        private const double DARK_MATTER_VOID_SIZE_FACTOR = 1 / 1e9;
        private const double DARK_MATTER_VOID_BARYONIC_MATTER_PERCENT_FACTOR = 100;
        private const double DARK_MATTER_VOID_DARK_MATTER_PERCENT_FACTOR = 150;
        private const double DARK_MATTER_VOID_DARK_ENERGY_PERCENT_FACTOR = 100;
        ...
        public double BaryonicMatterVoidDarkMatterPercentFactor { get; set; }
        ...
        public double DarkMatterVoidBaryonicMatterPercentFactor { get; set; }
        ...
        public GeneratorConfig()
        {
            ...
            this.BaryonicMatterVoidDarkMatterPercentFactor = BARYONIC_MATTER_VOID_DARK_MATTER_PERCENT_FACTOR;
            ...
            this.DarkMatterVoidBaryonicMatterPercentFactor = DARK_MATTER_VOID_BARYONIC_MATTER_PERCENT_FACTOR;
