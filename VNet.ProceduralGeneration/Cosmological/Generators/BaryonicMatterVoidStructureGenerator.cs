...
{
    public BaryonicMatterVoidStructureGenerator(IEventAggregator eventAggregator, IGeneratorInvokerService generatorInvokerService, IConfigurationService configurationService, ILogger<BaryonicMatterVoidStructureGenerator> loggerService, IAstronomicalCalculationService calculationService) : base(eventAggregator, generatorInvokerService, configurationService, loggerService, calculationService)
    {
    ...
    protected override async Task GenerateChildren(BaryonicMatterVoidStructureContext context, BaryonicMatterVoidStructure self)
    {
        ...
        {
            var newBaryonicMatterVoid = await GeneratorInvokerService.GenerateAsync<BaryonicMatterVoid, BaryonicMatterVoidContext>(baryonicMatterVoidContext, self.Parent);
            ...
            await GeneratorInvokerService.GeneratePositionAsync<BaryonicMatterVoid, BaryonicMatterVoidContext>(baryonicMatterVoidContext, newBaryonicMatterVoid);
